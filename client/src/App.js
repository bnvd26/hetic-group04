            ...
            <div id="rgpd" class="wrapper wrapper--rgpd">
              ...
              >
                ...
                <defs>
                  ...
                  >
                    <stop stop-color="#9E60E6" />
                    <stop offset="1" stop-color="#4E27E6" />
                  </linearGradient>
                </defs>
              </svg>
              ...
              <div class="content">
                ...
                <p>
                  ...
                  <br></br>
                  Le site internet www.hetic-groupe-04.fr est la propriété
                  excluse du Groupe 04 Hetic.
                </p>
                <h3>HÉBERGEMENT</h3>
                <p>
                ...
                <p>
                  ...
                  <br></br>- Hanaa Foutih (développeur front-end)<br></br>-
                  Céline Teixeira-Fernandes (designer UX/UI)<br></br>- Geoffrey
                  Guez (développeur front-end)<br></br>- Quentin Monteferrario
                ...
                <p>
                  ...
                  données personnelles et à la vie privée de tous les
                  utilisateurs de ses sites internet, vos données à caractère
                  personnel peuvent être collectées par le Groupe 04 à des fins
                  non commerciales.
                  <br></br>
                  <br></br>
                  ...
                  <br></br>
                  <br></br>
                  Vous pouvez à tout moment solliciter la suppression des
                  données collectées en nous contactant par voie électronique à
                  :&nbsp;
                  <a href="mailto:hetic-web3-groupe-04@hetic.net">
                    hetic-web3-groupe-04@hetic.net
                  </a>
                  <br></br>
                  <br></br>
                  Les données sont collectées uniquement pour le compte du
                  Groupe 04.
                  <br></br>
                  <br></br>
                ...
                <p>
                  ...
                  exhaustive, sont la propriété du Groupe 04. Toute
                  représentation et/ou reproduction et/ou exploitation partielle
                  ou totale des contenus et services proposés par quelque
                  procédé que ce soit, sans l’autorisation préalable et écrite
                  du Groupe 04 est strictement interdite. Dans l’hypothèse où
                  l’utilisateur souhaiterait utiliser un des contenus du site
                  (texte, image, etc.), il s’engage à requérir l’autorisation
                  préalable et écrite du Groupe 04, en nous contactant par voie
                  électronique à : remi.tiab@hetic.net, à défaut celui-ci
                  pourrait faire l’objet d’action et poursuites judicaires
                  prévues par le Code de la propriété intellectuelle et le Code
                  Civil.
                </p>
